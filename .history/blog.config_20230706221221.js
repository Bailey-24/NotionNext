...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个程序员, Hi，我是一名研究生, Hi，我是一个干饭人,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'George Bailey', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '👏Hi, 我是深圳大学计算机研究生朱家辉，我的方向是AI机器人感知与控制，比较感兴趣的是结合语言和视觉大模型为机器人赋能。我平时喜欢跑步，游泳，健身，跳kpop，周末喜欢去露营，做义工，参加活动，最喜欢干饭🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.bailey24.life', // 网站地址
  ...
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://www.zhihu.com/people/ali-80-26', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://blog.csdn.net/m0_48945359?spm=1011.2124.3001.5343', // 你的twitter个人主页
  ...
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || 'https://space.bilibili.com/513257621?spm_id_from=333.337.0.0', // 您的instagram地址
